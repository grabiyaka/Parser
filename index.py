...
xmlData = {
    'formdekor_data': generate_xml_f(getFormdekorData()),
    'techno_odis_data': generate_xml_t(getTechnoOdisData()),
    'hitbeton_data': generate_xml_h(getHitbetonData()),
