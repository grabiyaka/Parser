    ...
    try:
        ...
        for offer in offers:
            if article:
                ...
                if vendor_code_element is not None and vendor_code_element.text is not None:
...
xmlData = {
    ...
    'raduga_data_2':        getProductsXML('https://raduga-mebel.com.ua/products_feed.xml?hash_tag=9eb3ca8841cfc674dbc8f671f7a7ad8f&sales_notes=&product_ids=&label_ids=&exclude_fields=&html_description=1&yandex_cpa=&process_presence_sure=&languages=uk%2Cru&group_ids=97791228&nested_group_ids=97791228', 'Дуга'),
    ...
    'hanert':               getProductsXML('https://hanert.com.ua/my-account-2/', 'Хане'),
    ...
    'gofin':                getProductsXML('https://gofin.biz/index.php?route=extension/feed/neoseo_product_feed&name=prom_ru', 'Гофі'),
    ...
    'kukuruzabox':          getProductsXML('https://kukuruzabox.com.ua/ua/cp35969-programma-loyalnosti-dlya-postoyannyh-klientov.html', 'Ку'),
